...
| -------------------------------------------------------------- | -------------------------------- | ------------------- | ------------------------------------------------ | --------------------------------------------------------------------- |
| Backups gerenciados pelo sistema (bancos remotos dos clientes) | Configurável por servidor (cron em America/Sao_Paulo, RN-BACKUP-032) | GFS — RN-BACKUP-003 | Storage target configurado (Azure/S3/filesystem) | `a definir`                                                           |
